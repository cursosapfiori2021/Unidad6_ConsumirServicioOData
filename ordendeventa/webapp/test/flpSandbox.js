		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "ver el estado de las facturas de las orden de venta",
									"targetURL": "#nsordendeventa-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsordendeventa-display": {
								"semanticObject": "nsordendeventa",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.ordendeventa",
									"url": sap.ui.require.toUrl("ns/ordendeventa")
								}
							}
						}
					}
