sap.ui.define([
	...
	return Opa5.extend("ns.ordendeventa.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["ns/ordendeventa/localService/mockserver"], function (mockserver) {
